...
atime.list.3735 <- atime::atime_versions(
  ...
  expr=data.table:::`[.data.table`({
    for (r in 1:nrow(allIteration_dt)) {
      DoSomething(allIteration_dt[r, ])
    }
  }),
  #"Before"="",
  "Regression"="d47a83fb2e25582e508f191f87a31ca81b736b57",#Parent of the first commit in the PR that fixes the issue 
  "fixed"="958e3dd3cba7c259220aa653bef4beb8ad74b239") # last commit in the PR that fixes the issue (https://github.com/Rdatatable/data.table/pull/4488/commits)
```
